...
function ka(e, n, t) {
  return zn & 21
    ? (Me(t, n) || ((t = Ns()), ($.lanes |= t), (Tn |= t), (e.baseState = !0)),
      n)
...
const Rd = () => V.jsx("nav", { children: "Daily Goals" }),
  Od = ({ title: e, description: n, deleteTask: t, index: r }) =>
    V.jsxs("div", {
      className: "tasks",
      children: [
        V.jsxs("div", {
  ...
  Dd = () => V.jsxs(V.Fragment, { children: [V.jsx(Rd, {}), V.jsx(Md, {})] });
Ql.createRoot(document.getElementById("root")).render(
  V.jsx(gc.StrictMode, { children: V.jsx(Dd, {}) })
);
